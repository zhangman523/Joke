...
import com.zxf.joke.ui.fragment.CustomWebViewDialog;
...
/**
 * Created by zhangman on 16/3/29 09:48.
...
public class CustomDialogPresenter extends BasePresenter<ICustomDialog> {
  ...
  public CustomDialogPresenter(ICustomDialog view) {
    super(view);
  }
   ...
   */
  public static CustomWebViewDialog create(String dialogTitle, String htmlFileName,
      int accentColor) {
  ...
  public AlertDialog makeOkDialog(Fragment fragment, View customView) {
    ...
    AlertDialog dialog = new AlertDialog.Builder(fragment.getActivity()).setTitle(dialogTitle)
        .setView(customView)
   ...
   * show positive na
   */
  public AlertDialog makeMulActionDialog(Fragment fragment, View customView, String ok,
      DialogInterface.OnClickListener okListener, String negative,
      DialogInterface.OnClickListener negativeListener, String neutral,
  ...
  private void loadData(WebView webView, String htmlFileName, int accentColor) {
    try {
      ...
      InputStream json = webView.getContext().getAssets().open(htmlFileName);
